...
export default class Landing extends Component{
  ...
  render(){
    return(
      <div className="main centered-column">
       ...
       <img alt="Powered by Skynet" src={LogoText} style={{height: 50, position: 'absolute', top: 20, left: 20}} />
       <div className="centered-column mobile-progress" style={{flex: 1}}>
         <div className="centered-row" style={{width: '80%'}}>
           <div className="centered-column" style={{flex: 1, height: 150, position: 'relative'}}>
           ...
           <div className="centered-column" style={{flex: 1, height: 120, position: 'relative'}}>
       ...
       {!this.state.uploaded &&
         <div className="landing-demo-mobile">
         <div className="demo-header-mobile centered-row">
         ...
         {this.state.upload_type === 'text' &&
           <div className="centered-column" style={{height: '100%', width: '100%'}}>
             <div className="centered-column" style={{width: '98%', padding: 20, opacity: 0.75}}>
             ...
             <div className="centered-column" style={{width: '80%'}}>
           ...
           <div style={{height: '100%', width: '100%', position: 'relative'}}>
              ...
              {({getRootProps, getInputProps}) => (
                <section className="centered-column" style={{width: '100%'}}>
                  <div {...getRootProps({className: 'dropzone'})}>
                    <input {...getInputProps()} />
                    <span>
                      <Button style={{width: "100%", height: 80, padding: "0 !important"}} basic color="green">
             ...
             {this.state.chosen && this.state.file &&
               <div className="centered-column" style={{height: '100%', width: '100%'}}>
                 <div className="centered-column" style={{position: 'relative', width: '100%', height: 'calc(50vh - 50px)', flex: 1, borderBottom: "solid 1px rgba(255, 255, 255, 0.05)"}}>
